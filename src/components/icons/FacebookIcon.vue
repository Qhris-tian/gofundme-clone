<template>
  <svg fill="none" viewBox="0 0 24 24" id="facebook" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#aea)">
      <g clip-path="url(#aeb)">
        <g clip-path="url(#aec)">
    ...
    <defs>
      <clipPath id="aea"><path fill="#fff" d="M0 0h24v24H0z" /></clipPath>
      <clipPath id="aeb"><path fill="#fff" d="M0 0h24v24H0z" /></clipPath>
      <clipPath id="aec"><path fill="#fff" d="M0 0h24v24H0z" /></clipPath>
    </defs>
  </svg>
</template>
